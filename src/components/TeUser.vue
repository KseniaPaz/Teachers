    ...
    <div class="teachers__item">
        ...
        >
            <div class="popup__heading">
                <img class="popup__photo" :src="require(`@/assets/img/${userData.image}`)">
        ...
        <img class="teachers__photo" :src="require(`@/assets/img/${userData.image}`)">
        <h3 class="teachers__name"> {{ userData.name }} </h3>
        <p class="teachers__prof"> {{ userData.prof }} </p>
...
<script>
    import TePopUp from './TePopUp.vue';
